...
@Component({
  ...
  template: `
    <div data-testid="product-detail" class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <!-- Error State -->
      <div *ngIf="hasError && !isLoading" class="text-center py-24">
      ...
      <!-- Product Content -->
      <div *ngIf="product && !isLoading" class="lg:grid lg:grid-cols-2 lg:gap-x-8 lg:items-start">
        <!-- Image Gallery -->
        <div data-testid="product-images" class="flex flex-col-reverse">
          <!-- Thumbnail Images -->
          <div class="hidden mt-6 w-full max-w-2xl mx-auto sm:block lg:max-w-none">
            <div class="grid grid-cols-4 gap-6" *ngIf="productImages.length > 1">
              <button
        ...
        <div class="mt-10 px-4 sm:px-0 sm:mt-16 lg:mt-0">
          ...
          <!-- Variant Selection -->
          <div *ngIf="product.variants.length > 1" class="mt-8">
            ...
            <div class="mt-4 space-y-4">
              <div *ngFor="let option of product.options" class="space-y-2">
                ...
                <div class="flex flex-wrap gap-2">
                  <button
                    *ngFor="let value of getOptionValues(option.id)"
          ...
          <div class="mt-4">
            <div
              *ngIf="selectedVariant && selectedVariant.inventory_quantity > 0"
          ...
          <!-- Tags -->
          <div *ngIf="product.tags && product.tags.length > 0" class="mt-8">
