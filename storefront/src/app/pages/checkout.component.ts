          ...
          <ol class="flex items-center space-x-4 md:space-x-8">
            <li *ngFor="let step of steps; let i = index" class="flex items-center">
              <div class="flex items-center">
                ...
                >
                  <svg
                    *ngIf="step.completed && !step.current"
                    class="w-5 h-5"
                    fill="currentColor"
                    viewBox="0 0 20 20"
                  >
      ...
      <div class="lg:grid lg:grid-cols-12 lg:gap-x-12">
        ...
        <div class="lg:col-span-7">
          <div data-testid="checkout-form" class="space-y-8">
            ...
            <div *ngIf="currentStep === 'contact'" class="bg-white rounded-lg shadow p-6">
              <h2 class="text-lg font-medium text-gray-900 mb-4">Contact Information</h2>

              <!-- Guest/Login Options -->
              <div *ngIf="!currentCustomer" class="mb-6">
              ...
              <div
                *ngIf="checkoutType === 'login' && !currentCustomer"
            ...
            <div *ngIf="currentStep === 'shipping'" class="bg-white rounded-lg shadow p-6">
              ...
              <form (ngSubmit)="proceedToPayment()">
                ...
                <!-- Shipping Options -->
                <div *ngIf="shippingOptions.length > 0" data-testid="shipping-options" class="mt-6">
                    ...
                    >
                      <div class="flex items-center">
                        ...
                        <div class="ml-3">
                          ...
                          <p *ngIf="option.estimated_delivery" class="text-xs text-gray-400">
            ...
            <!-- Step 3: Payment -->
            <div *ngIf="currentStep === 'payment'" class="bg-white rounded-lg shadow p-6">
